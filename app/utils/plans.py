...
DEFAULT_PLANS = [
    {
        ...
        "max_users": 3,
        "description": "Pour demarrer : 1 ferme, 1 lot actif, jusqu'a 3 utilisateurs.",
        "sort_order": 1,
    },
    {
        "code": "standard",
        ...
        "max_users": 10,
        "description": "Jusqu'a 3 fermes, lots illimites, alertes email, export PDF.",
        "sort_order": 2,
    },
    {
        "code": "pro",
        ...
        "max_active_batches": None,
        "max_users": None,
        "description": "Fermes, lots et utilisateurs illimites, support prioritaire.",
        "sort_order": 3,
    },
]
